        ...
        <div className="flex min-h-screen flex-col bg-[#f5f6f8]">
            ...
            <main className="mx-auto w-full max-w-3xl px-6 py-8">
                ...
                <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                    <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Drop a new role! 🚀</h1>
                    ...
                    <div className="relative mt-2">
                        <textarea
                            ...
                            rows={10}
                            className="w-full resize-none rounded-xl border border-gray-200 bg-gray-50/50 px-5 py-4 text-sm leading-relaxed text-gray-700 placeholder:text-gray-400/70 focus:border-emerald-400 focus:bg-white focus:ring-2 focus:ring-emerald-100 transition-all"
                        />
                        {/* Send icon */}
